...
Gem::Specification.new do |s|
  ...
  s.email = %q{}
  s.extra_rdoc_files = ["CHANGELOG.txt", "LICENSE.txt", "README.rdoc", "lib/robot_remote_server.rb"]
  s.files = ["CHANGELOG.txt", "Gemfile", "Gemfile.lock", "LICENSE.txt", "Manifest", "README.rdoc", "Rakefile", "lib/robot_remote_server.rb", "robot_remote_server.gemspec"]
